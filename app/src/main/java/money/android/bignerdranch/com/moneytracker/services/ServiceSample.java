package money.android.bignerdranch.com.moneytracker.services;
...
public class ServiceSample extends Service implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void sendNotification() {
        ...
        Intent runActivityIntent = new Intent(ServiceSample.this, MainActivity.class);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.logo_log))
